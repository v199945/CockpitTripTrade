<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FcdsApply_List.aspx.cs" Inherits="CockpitTripTrade.Module.Application.CockpitTripTrade_Module_Application_FcdsApply_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Criteria</h2>
    <section class="vdrowcols-xxl3-md2-xs1">
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md">
                <asp:Label ID="lblApplicationDatePeriod" AssociatedControlID="txtApplicationDatePeriod" CssClass="col-form-label  label-sm" Text="Period" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
                    <asp:TextBox ID="txtApplicationDatePeriod" CssClass="form-control  form-control-sm" Enabled="true" style="background-image: url('../../asset/cont-img/icon-calendar.svg'); background-position: right center; background-repeat: no-repeat;" runat="server" />
        ...
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md">
                <asp:Label ID="lblAcType" AssociatedControlID="ddlAcType" CssClass="col-form-label  label-sm" Text="Fleet" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
                    <asp:DropDownList ID="ddlAcType" AppendDataBoundItems="true" CssClass="form-control  form-control-sm" DataTextField="IcaoCode" DataValueField="AcType" Enabled="false" runat="server">
        ...
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md">
                <asp:Label ID="lblCrewPos" AssociatedControlID="ddlCrewPos" CssClass="col-form-label  label-sm" Text="Rank" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
                    <asp:DropDownList ID="ddlCrewPos" AppendDataBoundItems="true" CssClass="form-control  form-control-sm" DataTextField="Code" DataValueField="ID" Enabled="false" runat="server">
                        <asp:ListItem Text="---Please Select---" Value="" />
                    </asp:DropDownList>
                </div>
            </div>
        ...
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md">
                <asp:Label ID="lblApplyStatus" AssociatedControlID="ddlStatusCode" CssClass="col-form-label  label-sm" Text="Status" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
                    <asp:DropDownList ID="ddlStatusCode" AppendDataBoundItems="true" CssClass="form-control  form-control-sm" DataTextField="DisplayStatus" DataValueField="StatusCodes" runat="server">
                        <asp:ListItem Text="---Please Select---" Value="" />
                    </asp:DropDownList>
                </div>
            </div>
        ...
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md">
                <asp:Label ID="lblIsApproval" AssociatedControlID="ddlIsApproval" CssClass="col-form-label  label-sm" Text="Result" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
        ...
        <div class="col-xl-4  col-lg-6  vdform-group">
            <div class="vdform-prop  vdform-prop-md" id="divLblIsOneReqATime" runat="server">
                <asp:Label ID="lblKeyword" AssociatedControlID="txtKeyword" CssClass="col-form-label  label-sm" Text="Search Term" runat="server" />
            </div>
            <div class="vdform-value">
                <div class="col-sm-12">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvList" AutoGenerateColumns="false" CssClass="table table-bordered table-striped table-hover  table-style01" DataKeyNames="IDFcdsApply" EmptyDataRowStyle-HorizontalAlign="Left" EmptyDataText="No Data!" HeaderStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true" runat="server" Width="100%" OnPreRender="gvList_PreRender" OnRowDataBound="gvList_RowDataBound">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ApplicationDate" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Application Date" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="ApplicationDeadline" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="First Duty Date" ItemStyle-HorizontalAlign="Center" />
                    ...
                    <asp:BoundField DataField="DisplayStatus" HeaderText="Status" ItemStyle-HorizontalAlign="Center" />
