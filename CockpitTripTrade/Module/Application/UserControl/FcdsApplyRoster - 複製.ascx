                ...
                <div id="divApplicantRoster" class="ss-1pdata" runat="server"><%--   ss-unselectable--%>
                    <div class="ss-pickdate">
                        <div class="form-check  form-check-inline">
                            ...
                            <asp:HiddenField ID="hfApplicantDutyDay" runat="server" />
                            <asp:HiddenField ID="hfApplicantDutyNo" runat="server" />
                            <asp:HiddenField ID="hfApplicantNumOfLeg" runat="server" />
                            <%--
                            ...
                            <ItemTemplate>
                                <div class="ss-flight">
                                    ...
                                    <span class="ss-rptime-block">
                                        <asp:Label ID="lblApplicantRpt" Text="CI: " Visible="false" runat="server" /><%--RPT : --%>
                                        <asp:Label ID="lblApplicantRptTime" CssClass="ss-rptime" runat="server" /><%--<span class="ss-rptime">07:00</span>--%>
                                        <asp:Label ID="lblApplicantDbf" Text="CO: " Visible="false" runat="server" />
                        ...
                        <asp:Repeater ID="repRespondentRosterLegs" runat="server" OnItemDataBound="repRespondentRosterLegs_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <div class="ss-flight">
                                    ...
                                    <span class="ss-rptime-block">
                                        <asp:Label ID="lblRespondentRpt" Text="CI: " Visible="false" runat="server" /><%--RPT : --%>
                                        <asp:Label ID="lblRespondentRptTime" CssClass="ss-rptime" runat="server" /><%--<span class="ss-rptime">07:00</span>--%>
                                        <asp:Label ID="lblRespondentDbf" Text="CO: " Visible="false" runat="server" />
