<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="FcdsApply.aspx.cs" Inherits="CockpitTripTrade.Module.Application.CockpitTripTrade_Module_Application_FcdsApply" %>
    ...
    <section class="mb-5">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="apply-tab" data-toggle="tab" href="#apply" role="tab" aria-controls="apply" aria-selected="true">Form</a>
            </li>
            <%--<li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="approvalhistory-tab" data-toggle="tab" href="#approvalhistory" role="tab" aria-controls="approvalhistory" aria-selected="false">Approval Route</a>
            </li>
            <%--<li class="nav-item" role="presentation">
            ...
            <div class="tab-pane fade py-2 show active" id="apply" role="tabpanel" aria-labelledby="apply-tab">
                <section class="vdform-has-mustfill mb-3">
                    <div class="row  form-2col">
                        <div class="col-lg-6  vdform-group">
                            <div class="vdform-prop  vdform-prop-md">
                                <asp:Label ID="lblIDFcdsApply" AssociatedControlID="IDFcdsApply" CssClass="col-form-label  label-sm" Text="Form Number" runat="server" />
                            </div>
                        ...
                        <div class="col-lg-6  vdform-group">
                            <div class="vdform-prop  vdform-prop-md">
                                <asp:Label ID="lblStatusCode" AssociatedControlID="StatusCode" CssClass="col-form-label  label-sm" Text="Form Status" runat="server" />
                            </div>
                            <div class="vdform-value">
                                <div class="col-sm-12">
                    ...
                    <div class="row  form-2col">
                        ...
                        <div class="col-lg-6  vdform-group">
                            <div class="vdform-prop  vdform-prop-md">
                                <asp:Label ID="lblApplicationDeadline" AssociatedControlID="ApplicationDeadline" CssClass="col-form-label  label-sm" Text="First Duty Date" runat="server" />
                            </div>
                            <div class="vdform-value">
                                <div class="col-sm-12">
                ...
                <uc1:FcdsApplyApprove ID="FcdsApplyApprove1" Visible="false" runat="server" />
                <div class="button-fixed-bottom-undermd">
                    ...
                    <button id="checkReturn" type="button" class="btn btn-outline-danger" data-target="" data-toggle="modal" runat="server" onclick="javascript:openBootstrapModal('checkReturnDialogModal');">Confirm to Return</button>
                    <button id="checkRevoke" type="button" class="btn btn-outline-danger" data-target="" data-toggle="modal" runat="server" onclick="javascript:openBootstrapModal('checkRevokeDialogModal');">Confirm to Revoke</button>
                    ...
                    <asp:Button ID="btnReturn" CausesValidation="false" CssClass="btn btn-outline-danger" Text="退回" runat="server" OnClick="btnReturn_Click" />
    ...
    <div id="checkSaveDialogModal" aria-labelledby="checkSaveDialogLabel" class="modal fade" data-backdrop="static" role="dialog" tabindex="-1" style="display: none;"><%-- aria-hidden="true" padding-right: 17px;--%>
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
                    <p>Are you sure to submit to Crew Scheduling Dept?</p>
				</div>
				<div class="modal-footer justify-content-center">
                    <asp:Button ID="btnSave" CausesValidation="false" CssClass="btn btn-primary" Text="Save" runat="server" OnClick="btnSave_Click" />
					<button class="btn btn-outline-primary" data-dismiss="modal" type="button">Cancel</button>
    ...
    <div id="checkSaveCompleteDialogModal" aria-labelledby="checkSaveCompleteDialogLabel" class="modal fade" data-backdrop="static" data-keyboard="false" role="dialog" tabindex="-1" style="display: none;"><%-- aria-hidden="true" padding-right: 17px;--%>
		<div class="modal-dialog modal-dialog-centered modal-sm">
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-center">
					<button class="btn btn-primary" data-dismiss="modal" data-toggle="modal" tabindex="0" type="button" onclick="window.location='TaskList.aspx';">Confirm</button>
				</div>
			</div>
		</div>
    </div>
