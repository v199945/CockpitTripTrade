<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApprovalHistory.ascx.cs" Inherits="CockpitTripTrade.UserControl.UserControl_ApprovalHistory" %>

<div class="table-responsive">
    <asp:GridView ID="gvApprovalHistory" AutoGenerateColumns="false" CssClass="table table-bordered table-striped table-hover  table-style01" DataKeyNames="" EmptyDataRowStyle-HorizontalAlign="Left" EmptyDataText="No Data!" HeaderStyle-HorizontalAlign="Center" HorizontalAlign="Center" ShowHeaderWhenEmpty="true" Width="80%" runat="server" OnPreRender="gvApprovalHistory_PreRender" OnRowDataBound="gvApprovalHistory_RowDataBound">
        <Columns>
