<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="CockpitTripTradeAdmin.Logout" %>
        ...
        <div id="wrapper">
	        ...
	        <div class="containerblock">
                ...
                <div id="block02" class="">
                    <h2 class="mt-0  text-center">Your logout have not completed</h2>
                    <p class="text-center">If you are sure to louout this system, please click the following [Logout] button.</p>
                    <p class="text-center  mt-4  mb-5">
                        <asp:LinkButton ID="lbtnLogout" CssClass="btn btn-primary-sp" Text="Logout" runat="server" OnClick="lbtnLogout_Click" />
