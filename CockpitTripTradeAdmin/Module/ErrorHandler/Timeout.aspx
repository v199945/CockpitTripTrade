<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Timeout.aspx.cs" Inherits="CockpitTripTradeAdmin.Module.ErrorHandler.Timeout" %>
        ...
        <div id="wrapper">
	        ...
	        <div class="containerblock">
    	        <div id="block01">
                    ...
                    <div id="block01-body">         
                        <p  class="text-center">
                            <img src="../../asset/v3.0.0/images/img-temp-conblock-v3s/status-logout.svg" alt="" />
                        </p>
                    </div><!--block-body End-->
                </div><!-- block01 End -->

                <div id="block02" class="">
                    <h2 class="mt-0  text-center">Session Timeout</h2>
                    <p class="text-center">There was a period of time you didn't use that you were log out by system automatically. If you need to use system again, please login again.</p>
                    <p class="text-center  mt-4  mb-5">
                        <asp:HyperLink ID="hlLogin" CssClass="btn btn-primary-sp" NavigateUrl="~/Login.aspx" Text="Login" runat="server" />
