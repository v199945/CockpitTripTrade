<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnauthorizedPage.aspx.cs" Inherits="CockpitTripTradeAdmin.UnauthorizedPage" %>
        ...
        <div id="wrapper">
	        ...
	        <div class="containerblock">
    	        <div id="block01">
                    ...
                    <div id="block01-body">         
                        <p  class="text-center">
                            <img src="../../asset/v3.0.0/images/img-temp-conblock-v3s/status-permission.svg" alt="" />
                        </p>
                    </div><!--block-body End-->
                </div><!-- block01 End -->

                <div id="block02" class="">
                    <h2 class="mt-0  text-center">Permission Denied</h2>
                    <p class="text-center  mb-5">You do not have system permissions, if you need to access this system, please kindly contact (#3783 蕭博元).</p>
