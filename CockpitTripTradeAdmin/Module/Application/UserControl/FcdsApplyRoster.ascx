<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FcdsApplyRoster.ascx.cs" Inherits="CockpitTripTradeAdmin.Module.Application.UserControl.CockpitTripTradeAdmin_Module_Application_UserControl_FcdsApplyRoster" %>
