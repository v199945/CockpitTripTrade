<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FcdsApplyApprove.ascx.cs" Inherits="CockpitTripTradeAdmin.Module.Application.UserControl.CockpitTripTradeAdmin_Module_Application_UserControl_FcdsApplyApprove" %>
    ...
    <div class="col-lg-12   col-xl-8   col-xxl-6">
        <section class="vdrowcols-xs1  mb-3  vdform-has-mustfill">
            ...
            <div class="vdform-group">
                ...
                <div class="vdform-value">
                    <div class="col">
                        <asp:TextBox ID="Comments" CssClass="form-control  form-control-sm" MaxLength="1000" TextMode="MultiLine" runat="server" />
                    </div>
                </div>
            </div><!-- vdform-group end-->
        </section><!--  -->
