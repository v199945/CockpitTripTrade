<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="ImpersonateUser.aspx.cs" Inherits="CockpitTripTradeAdmin.Module.Admin.CockpitTripTradeAdmin_Module_Admin_ImpersonateUser" %>
            ...
            <div class="row  form-2col">
                <div class="col-lg-6  vdform-group">
                    <div class="vdform-prop  vdform-prop-md">
                        ...
                        <asp:Label ID="lblImpersonate" AssociatedControlID="Impersonate" CssClass="col-form-label  label-sm" Text="Employee ID" runat="server" />
                    </div>
                    <div class="vdform-value">
                        <div class="col-sm-12">
                            <asp:TextBox ID="Impersonate" CssClass="form-control  form-control-sm" MaxLength="6" placeholder="Please input Employee ID" runat="server" />
                            <asp:RegularExpressionValidator ID="revImpersonate" ControlToValidate="Impersonate" CssClass="invalid-feedback" Display="Dynamic" ErrorMessage="[ Employee ID ] must be 6 digits!" SetFocusOnError="true" ValidationExpression="^\d{6}$" runat="server" />
                            <asp:RequiredFieldValidator ID="rfvImpersonate" ControlToValidate="Impersonate" CssClass="invalid-feedback" Display="Dynamic" ErrorMessage="[ Employee ID ] is required!" SetFocusOnError="true" runat="server" />
